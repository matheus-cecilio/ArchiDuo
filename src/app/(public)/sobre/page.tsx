      ...
      <section className="section-padding bg-[var(--color-secondary)]">
        <div className="container-custom">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold font-[family-name:var(--font-playfair)] text-[var(--color-accent)] mb-4">
              Nossa <span className="text-gradient-gold">Jornada</span>
            </h2>
          </motion.div>

          <div className="max-w-3xl mx-auto">
            {[
              { year: "2018", title: "O Início", description: "Fundação do escritório com foco em projetos residenciais." },
              { year: "2020", title: "Expansão", description: "Ampliação para projetos comerciais e parcerias estratégicas." },
              { year: "2022", title: "Reconhecimento", description: "Premiação como um dos escritórios mais inovadores da região." },
              { year: "2024", title: "Hoje", description: "Mais de 50 projetos realizados e clientes satisfeitos." },
            ].map((item, index) => (
              <motion.div
                key={item.year}
              ...
              >
                <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[var(--color-primary)] flex items-center justify-center">
                  <span className="text-[var(--color-secondary)] font-bold text-sm">
                    {item.year}
                  </span>
                </div>
                <div className="pt-3">
                  <h3 className="text-lg font-semibold text-[var(--color-accent)] mb-1">
                    {item.title}
                  </h3>
